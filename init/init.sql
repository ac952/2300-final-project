...
INSERT INTO events (event_name, event_date, event_time, location, description) VALUES ('Earth Day Gorge Clean-up','04-22-18','2:30pm','Johnson Museum of Art', 'In honor of Earth day, will be working with the Society for Natural Resources Conservation to clean up our local gorges.');
INSERT INTO events (event_name, event_date, event_time, location, description) VALUES ('Ithaca Children Garden Spring Cleaning', '04-28-18','9:00am','Ithaca Children Garden', 'Assisting with mulch, construction, and plant care in preparation for spring festivals.');
INSERT INTO events (event_name, event_date, event_time, location, description) VALUES ('Girls Adventures in Math','04-29-18','2:30pm','On Campus', 'Helping proctor, grade, and play games at a team-based math competition for girls in the 3rd-8th grade.');
INSERT INTO events (event_name, event_date, event_time, location, description) VALUES ('Circle K Social','05-05-18','6:00pm','Helen Newmann Bowling Alleys', 'To recap and recognize our philanthropic efforts thorughout this past semester. Free drinks and pizza!');
INSERT INTO events (event_name, event_date, event_time, location, description) VALUES ('Adopt a Highway','05-06-18','10:00am','Brooktondale Baptist Church', 'Picking up trash along local Ithaca highways to keep roads clean.');
